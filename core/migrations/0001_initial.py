    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='timeslots', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('meeting_mode', models.CharField(default='online', max_length=50)),
